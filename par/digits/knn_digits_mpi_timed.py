...
# --- Comunicación 1: bcast + scatter ya ocurrieron justo antes,
# pero para simplificar medimos desde aquí solo scatter+gather.
# Vamos a medir comunicación como:
#   (tiempo scatter/bcast) + (tiempo gather)

comm1_start = MPI.Wtime()
# (ya hicimos bcast+scatter, así que comm1 ≈ 0, pero lo dejamos estructurado por claridad)
comm1_end = MPI.Wtime()
...
# En paralelo, nos interesa el tiempo "crítico" (el del proceso más lento)
